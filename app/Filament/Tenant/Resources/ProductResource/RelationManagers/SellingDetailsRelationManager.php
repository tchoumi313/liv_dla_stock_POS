        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('price')
                    ->translateLabel()
                    ->sortable()
                    ->money(Setting::get('currency', 'XOF')),
                Tables\Columns\TextColumn::make('discount')
                    ->getStateUsing(
                        fn(SellingDetail $sellingDetail) => Number::currency(
                            $sellingDetail->discount_price,
                            Setting::get('curerncy', 'XOF')
                        )
                    )
                    ->translateLabel()
                    ->sortable()
                ...
                Tables\Columns\TextColumn::make('discount_price')
                    ->getStateUsing(
                        fn(SellingDetail $sellingDetail) => Number::currency(
                            $sellingDetail->price - $sellingDetail->discount_price,
                            Setting::get('curerncy', 'XOF')
                        )
                    )
                    ->translateLabel()
