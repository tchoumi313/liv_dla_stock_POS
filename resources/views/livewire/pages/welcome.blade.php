...
$prices = [
    [
        ...
        'excludes' => ['Gratis biaya pemasangan', 'Maintenance', 'Dukungan 24 jam', 'Menyediakan backup data', 'Pembaharuan fitur'],
    ],
    [
        'title' => 'Server kami',
        ...
        'button' => 'Bagaimana caranya?',
        'route' => '',
        'includes' => ['Semua fitur gratis', 'Gratis biaya pemasangan', 'Maintenance', 'Dukungan 24 jam', 'Menyediakan backup data', 'Pembaharuan fitur'],
        'excludes' => [],
    ],
];
...
<div>
    <section class="w-full bg-white lg:h-screen md:h-[80vh]" data-tails-scripts="//unpkg.com/alpinejs">
            ...
            <div class="w-full px-6 mx-auto leading-10 text-center lg:px-8 max-w-7xl">
                <div class="box-border flex flex-wrap items-center justify-between -mx-4 text-indigo-900">
                    <div
                        ...
                        <a href="/"
                            class="flex box-border font-sans text-2xl font-bold text-left text-gray-900 no-underline bg-transparent cursor-pointer focus:no-underline items-end gap-x-2">
                            <img src="{{ env('APP_URL') }}/assets/logo/image.png" class="h-10">
                            <p>Lakasir</p>
                        </a>
                    </div>
                    ...
                    <div
                        ...
                        <a href="https://wa.me/6289638706830?text=Halo%20dengan%20lakasir%2C%20saya%20ingin%20mengatur%20jadwal%20demo%20dengan%20Anda.%20Bisakah%20kita%20membicarakannya%20lebih%20lanjut%3F"
                            class="bg-gray-100 text-gray-400 md:w-auto w-full px-8 py-3 rounded-full flex items-center justify-center font-medium text-lg focus:ring-offset-2 focus:ring-2 focus:ring-gray-100 focus:text-gray-700 hover:text-gray-700">Jadwalkan
                            Demo</a>
                        <a href="{{ route('auth.register') }}"
                            class="bg-lakasir-primary text-white md:w-auto w-full px-8 py-3 rounded-full flex items-center justify-center font-medium text-lg focus:ring-offset-2 focus:ring-2 focus:ring-lakasir-primary">Daftar</a>
                    </div>
                    ...
                    <div class="md:hidden">
                        <div>
                            <div>
                                <button
                                    class="text-white hidden left-10 fixed top-20 text-2xl px-3 py-1 bg-lakasir-primary rounded-lg"
                                    x-ref="xButton"
                                    x-on:click="$refs.menu.classList.toggle('hidden'); $refs.xButton.classList.toggle('hidden');">X</button>
                            </div>
                            <div class="fixed inset-y-0 right-0 w-64 bg-gray-800 text-white flex-col justify-between z-20 hidden"
                                x-ref="menu">
                                <!-- Links -->
                                <div class="flex flex-col mt-8">
                                    <a href="#" class="px-6 py-3 text-sm font-medium">Jadwalkan Demo</a>
                                    <a href="{{ route('auth.register') }}"
                                        class="px-6 py-3 text-sm font-medium">Daftar</a>
                                </div>
                            </div>
                        </div>
                        <!-- Content -->
                        <div class="flex items-center justify-center h-full mr-5 text-gray-800"
        ...
        <div x-ref="dialog"
            ...
            <div class="w-full flex justify-end cursor-pointer"
                x-on:click="$refs.overlay.classList.add('hidden'); $refs.dialog.classList.add('hidden');">
                <button class="text-gray-600">X</button>
            </div>
            <iframe width="1024" height="576"
                src="https://www.youtube.com/embed/O5rYsoAZ_sk?si=kPhn1AxNqTgQR3Sf&amp;controls=0"
            ...
            <div class="max-w-7xl px-10 mx-auto flex lg:flex-row flex-col py-20">
                <div class="w-full lg:w-1/2 flex lg:justify-start justify-start md:justify-center hero-title">
                    <div class="lg:py-24  lg:text-left text-left md:text-center">
                        <br />
                        <h1
                            class="mt-4 text-4xl tracking-tight font-extrabold text-gray-800 sm:mt-5 lg:text-left text-left md:text-center sm:text-6xl lg:mt-6 xl:text-7xl">
                            <span class="block">Lakasir</span>
                            <span
                                class="text-lakasir-primary flex items-center justify-start lg:justify-start md:justify-center w-full">Free
                                POS</span>
                        </h1>
                        <p
                            class="mt-3 text-base text-gray-400 sm:mt-5 sm:text-xl lg:text-lg  lg:text-left text-left md:text-center xl:text-xl">
                        ...
                        <div class="mt-6 sm:mt-8">
                            <div
                                class="flex md:flex-row flex-col md:space-x-5 md:space-y-0 space-y-5 lg:justify-start justify-center">
                                <a href="https://github.com/lakasir/lakasir_flutter/releases" target="_blank"
                                    class="bg-lakasir-primary text-white md:w-auto w-full px-8 py-4 rounded-full flex items-center justify-center font-medium text-lg focus:ring-offset-2 focus:ring-2 focus:ring-lakasir-primary">Unduh
                                    Sekarang</a>
                                <a href="#_"
                                    ...
                                    <span class="-ml-2 mr-3"><svg class="w-6 h-6" fill="currentColor"
                ...
                <div
                    class="w-full lg:w-1/2 lg:flex lg:justify-center lg:max-w-none max-w-md lg:mt-0 mt-20 mx-auto relative hidden hero-phone">
                    <div
                        class="w-auto sm:w-64 absolute bottom-0 transform md:bottom-auto md:top-1/2 p-8 translate-y-16 md:translate-y-24 md:ml-16 z-10 left-0 bg-white text-gray-400 rounded-xl shadow-2xl hidden md:block">
                        <div
                            class="inline-flex absolute top-0 transform -translate-y-full bg-lakasir-primary left-0  space-x-1 px-4 items-center h-9 w-auto rounded-full -mt-2">

                            <svg class="w-4 h-4 text-white fill-current" viewBox="0 0 534 509"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="m409.8 313.24 114.8-94.637c16.238-13.441 7.84-39.762-13.441-40.879l-147.84-8.96c-8.96-.56-16.801-6.161-20.16-14.56l-54.32-138.88c-7.84-19.602-35.281-19.602-43.121 0l-54.32 138.32c-3.36 8.399-11.199 14-20.16 14.56l-148.4 8.96c-21.281 1.121-29.68 27.441-13.441 40.879l114.8 94.078c6.719 5.602 10.078 15.121 7.84 23.52l-37.52 143.92c-5.04 20.16 16.8 36.398 34.719 25.199l124.88-80.078c7.84-5.04 17.359-5.04 24.64 0l125.44 80.078c17.923 11.199 39.763-5.04 34.72-25.199l-37.52-143.36c-1.68-8.398 1.12-17.359 8.402-22.961h.002Z"
                                    fill-rule="nonzero" />
                            </svg>
                            <svg class="w-4 h-4 text-white fill-current" viewBox="0 0 534 509"
                                xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="about" class="bg-gray-800 text-white py-32">
        <div class="lg:max-w-3xl mx-auto text-center px-5 lg:px-0">
            ...
            <p class="text-lg mt-5">Lakasir adalah aplikasi POS open-source dan juga gratis, lakasir tersedia untuk
                android dan web, dengan fitur yang dimiliki lakasir sekarang lakasir bisa memudahkan anda dalam mencatat
                keuntungan anda perhari dengan mudah, lakasir juga bisa membantu anda dalam mengelola barang yang ada di
                toko anda, dengan fitur yang lengkap dan mudah digunakan.</p>
        </div>
    </section>
    ...
    <section id="main-feature" class="bg-gray-800 text-white py-32">
        <div class="md:max-w-4xl max-w-1xl mx-auto">
            <div class="mb-20 grid grid-cols-1 gap-y-5">
                ...
                <p class="text-lg text-center sm:mx-0 mx-5">Dengan lakasir anda bisa mengelola toko anda dengan mudah,
                    berikut fitur yang dimiliki oleh lakasir.</p>
            </div>
    ...
    <section id="price">
        <div class="mx-auto max-w-7xl py-24 px-6 lg:px-8">
            ...
            <div
                class="mt-12 space-y-4 sm:mt-16 sm:grid sm:grid-cols-2 sm:gap-6 sm:space-y-0 mx-auto max-w-4xl xl:mx-0 xl:max-w-none justify-items-center">
                @foreach ($prices as $price)
                    <div class="divide-y divide-gray-200 rounded-lg border border-gray-200 shadow-sm w-80">
                        <div class="p-6">
                            ...
                            <p class="mt-8">
                                <span
                                    class="text-4xl font-bold tracking-tight text-gray-900">{{ $price['price'] }}</span>
            ...
            <form action="#" class="mt-5 sm:mx-auto sm:flex sm:max-w-lg">
                <div class="min-w-0 flex-1">
                    ...
                    <input id="cta-email" type="email"
                        class="block w-full rounded-md border border-transparent px-5 py-3 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-lakasir-primary"
                        placeholder="Enter your email">
                </div>
                <div class="mt-4 sm:mt-0 sm:ml-3">
                    <button type="submit"
                        class="block w-full rounded-md border border-transparent bg-orange-600 px-5 py-3 text-base font-medium text-white shadow hover:bg-lakasir-primary focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-lakasir-primary sm:px-10">Notify
                        me</button>
                </div>
            </form>
        </div>
